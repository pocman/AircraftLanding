...
public class InstanceGenerator {
	...
	public static AircraftLanding generator(TAILLE_AEROPORT tailleAeroport, int alea, boolean fenetreFixe){
		...
		case PETIT :
			...
			for(int i=0; i<nbPlanesSmall; i++) {
				String timeWindow=String.valueOf(30+r.nextInt(240));	// max landing duration 
	...
	public static void main(String[] args) {
		AircraftLanding instance=generator(TAILLE_AEROPORT.GRAND, 12, true);
		String[] schedule=instance.getSchedule();
		System.out.println("Instance pour un aeroport de taille moyenne et fenetre de temps fixees");
		System.out.println("");
